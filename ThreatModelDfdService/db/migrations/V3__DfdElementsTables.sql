...
ALTER TABLE dfd_elements
ADD CONSTRAINT fk_dfd_elements_dfd_id FOREIGN KEY (dfd_id) REFERENCES dfds(id);

CREATE TABLE actors (
    id BIGINT PRIMARY KEY,
    FOREIGN KEY (id) REFERENCES dfd_elements(id)
);
...
CREATE TABLE data_flows (
    ...
    FOREIGN KEY (dfd_id) REFERENCES dfds(id)
);